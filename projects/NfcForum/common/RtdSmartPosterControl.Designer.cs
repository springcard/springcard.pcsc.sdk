...
namespace SpringCardApplication
{
  partial class RtdSmartPosterControl
  {
    ...
    {
      this.nfcRtdUriControl1 = new SpringCardApplication.RtdUriControl();
      ...
      this.nfcRtdTextControl1 = new SpringCardApplication.RtdTextControl();
    ...
    private SpringCardApplication.RtdTextControl nfcRtdTextControl1;
    private SpringCardApplication.RtdUriControl nfcRtdUriControl1;
