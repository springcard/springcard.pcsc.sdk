...
namespace NFCToolDesfire
{
	class Program
	{
		...
		{
		  Console.WriteLine("NfcToolDesfire: Format Desfire EV1 cards to hold NFC Forum compliant Tags (SmartPoster)");
			Console.WriteLine("");
		...
		public static void helpmsg(string s, bool nfc_silent)
		{
		  if (!nfc_silent)
		    ...
		    Console.WriteLine("Call NfcToolDesfire.exe -h for Help");
			}
		}
