...
@echo -- Create an application (6 keys, TDES)
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep CreateApplication --application-id=544445 --key-settings=0F07
if errorlevel 1 ( goto :the_end )

@echo -- Select application 544445
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep SelectApplication --application-id=544445
if errorlevel 1 ( goto :the_end )
...
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=01 --old-key-value=00000000000000000000000000000000 --key-value=101112131415161718191A1B1C1D1E1F
if errorlevel 1 ( goto :the_end )
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=02 --old-key-value=00000000000000000000000000000000 --key-value=202122232425262728292A2B2C2D2E2F
if errorlevel 1 ( goto :the_end )
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=03 --old-key-value=00000000000000000000000000000000 --key-value=303132333435363738393A3B3C3D3E3F
if errorlevel 1 ( goto :the_end )
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=04 --old-key-value=00000000000000000000000000000000 --key-value=404142434445464748494A4B4C4D4E4F
if errorlevel 1 ( goto :the_end )
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=05 --old-key-value=00000000000000000000000000000000 --key-value=505152535455565758595A5B5C5D5E5F
if errorlevel 1 ( goto :the_end )
@%DESFIRE_TOOL% --verbose=%DEBUG_LEVEL% --keep ChangeKey --key-id=06 --old-key-value=00000000000000000000000000000000 --key-value=606162636465666768696A6B6C6D6E6F
if errorlevel 1 ( goto :the_end )
