...
{
	/**
	 * \brief Manipulation of CSV files
	 */
	public abstract class CsvFileCommon
	{
		/**
		 * \brief Determines how empty lines are interpreted when reading CSV files.
		...
		{
			/**
			 * \brief Empty lines are interpreted as a line with zero columns.
			 */
			NoColumns,
			/**
			 * \brief Empty lines are interpreted as a line with a single empty column.
			 */
			EmptyColumn,
			/**
			 * \brief Empty lines are skipped over as though they did not exist.
			 */
			Ignore,
			/**
			 * \brief An empty line is interpreted as the end of the input file.
			 */
			EndOfFile,
		}

		/**
	     * \brief These are special characters in CSV files.
		 * 
		...
		/**
	     * \brief Gets/sets the character used for column delimiters.
	     */
		...
		/**
	     * \brief Gets/sets the character used for column quotes.
	     */
	    public char Quote
	    {
	...
	/**
	 * \brief Class for reading from comma-separated-value (CSV) files
	 */
	public class CsvFileReader : CsvFileCommon, IDisposable
	{
	    ...
	    public bool ReadRow(ref List<string> columns)
	    {
	...
	/**
	  * \brief Class for writing to comma-separated-value (CSV) files.
	  */
