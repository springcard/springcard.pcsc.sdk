...
namespace SpringCard.PCSC
{
	...
	/// </summary>
	public class CcidBleServiceConfig
	{
        ...
        public CcidBleServiceConfig(Mode mode)
		{
			this.mode = mode;        	
		...
		public RegistryKey RuntimeKey(string deviceName, Mode mode)
		{
            ...
            try
            {
                ...
                {
                    k = baseKey32.OpenSubKey(_ServiceConfigRuntimeSubKey64, RegistryKeyPermissionCheck.ReadSubTree, RegistryRights.FullControl);
                }
		...
		public bool InstallDevice(string DeviceName, string HostName, string FriendlyName)
		{
			RegistryKey k = null;
            ...
            try
            {
                ...
                if (k != null)
                {
                    ...
                    if (deviceKey != null)
                    {
                        ...
                        deviceKey.SetValue("ProbeInterval", 10, RegistryValueKind.DWord);
                        deviceKey.SetValue("ProbeTimeout", 5, RegistryValueKind.DWord);
