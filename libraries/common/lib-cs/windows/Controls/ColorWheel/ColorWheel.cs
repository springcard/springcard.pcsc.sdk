...
namespace SpringCard.LibCs.Windows.Controls.ColorWheel
{
    ...
    public class ColorWheel : IDisposable
    {
        ...
        private RGB RGB = new RGB(0xFF, 0xFF, 0xFF);
        private HSV HSV = new HSV(0x00, 0x00, 0xFF);
        ...
        private byte brightnessMin;
        private byte brightnessMax;
        ...
        public ColorWheel(Rectangle colorRectangle, Rectangle brightnessRectangle, Rectangle selectedColorRectangle)
        {
            ...
            using (GraphicsPath path = new GraphicsPath())
            {
                ...
                this.brightnessMin = (byte)this.brightnessRectangle.Top;
                this.brightnessMax = (byte)this.brightnessRectangle.Bottom;

                // Create a region corresponding to the brightness rectangle, with a little extra "breathing room". 
        ...
        {
            // Given the top color, draw a linear gradient ranging from black to the top color. Use the 
