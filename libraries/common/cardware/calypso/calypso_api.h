...
CALYPSO_PROC CalypsoCardSelectInnovatron(P_CALYPSO_CTX ctx, const BYTE atr[], SIZE_T atrlen);
CALYPSO_PROC CalypsoCardSelectTcl(P_CALYPSO_CTX ctx, BYTE cid, BYTE cla);
...
CALYPSO_PROC CalypsoSamTransmit(P_CALYPSO_CTX ctx, const BYTE in_buffer[], SIZE_T in_length, BYTE out_buffer[], SIZE_T *out_length);
CALYPSO_PROC CalypsoSamTransmitDirty(P_CALYPSO_CTX ctx, const BYTE in_buffer[], SIZE_T in_length);
...
CALYPSO_PROC CalypsoCardGetAtr(P_CALYPSO_CTX ctx, BYTE atr[], SIZE_T *atrsize);
CALYPSO_PROC CalypsoCardSelectApplication(P_CALYPSO_CTX ctx, const BYTE aid[], SIZE_T aidsize, BYTE fci[], SIZE_T *fcisize);
CALYPSO_PROC CalypsoCardSelectDF(P_CALYPSO_CTX ctx, WORD file_id, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardSelectDFEx(CALYPSO_CTX_ST *ctx, BYTE param1, WORD file_id, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardSelectEF(P_CALYPSO_CTX ctx, WORD file_id, BYTE resp[], SIZE_T *respsize);
...
CALYPSO_PROC CalypsoCardReadRecord(P_CALYPSO_CTX ctx, BYTE sfi, BYTE rec_no, BYTE rec_size, BYTE data[], SIZE_T *datasize);
...
CALYPSO_PROC CalypsoCardOpenSecureSessionEx(P_CALYPSO_CTX ctx, BYTE apdu_p1, BYTE apdu_p2, const BYTE sam_chal[4], BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardOpenSecureSession1(P_CALYPSO_CTX ctx, BYTE resp[], SIZE_T *respsize, BYTE key_no, BYTE sfi, BYTE rec_no, const BYTE sam_chal[4], BYTE card_chal[4], BOOL *ratified, BYTE data[], SIZE_T *datasize);
CALYPSO_PROC CalypsoCardOpenSecureSession2(P_CALYPSO_CTX ctx, BYTE resp[], SIZE_T *respsize, BYTE key_no, BYTE sfi, BYTE rec_no, const BYTE sam_chal[4], BYTE card_chal[4], BOOL *ratified, BYTE data[], SIZE_T *datasize, BYTE *kvc);
CALYPSO_PROC CalypsoCardOpenSecureSession3(P_CALYPSO_CTX ctx, BYTE resp[], SIZE_T *respsize, BYTE key_no, BYTE sfi, BYTE rec_no, const BYTE sam_chal[4], BYTE card_chal[4], BOOL *ratified, BYTE data[], SIZE_T *datasize, BYTE *kvc, BYTE *kif);
CALYPSO_PROC CalypsoCardCloseSecureSession(P_CALYPSO_CTX ctx, BOOL ratify_now, const BYTE sam_sign[4], BYTE resp[], SIZE_T *respsize);
...
CALYPSO_PROC CalypsoCardActivate(P_CALYPSO_CTX ctx, const BYTE aid[], SIZE_T aidsize);
...
CALYPSO_PROC CalypsoCardDFName(P_CALYPSO_CTX ctx, BYTE name[], SIZE_T *namesize);
...
CALYPSO_PROC CalypsoSamDigestInit(P_CALYPSO_CTX ctx, BYTE kif, BYTE kvc, const BYTE card_resp_buffer[], SIZE_T card_resp_length);
CALYPSO_PROC CalypsoSamDigestInitCompat(P_CALYPSO_CTX ctx, BYTE kno, const BYTE card_resp_buffer[], SIZE_T card_resp_length);
CALYPSO_PROC CalypsoSamDigestUpdate(P_CALYPSO_CTX ctx, const BYTE card_buffer[], SIZE_T card_buflen);
...
CALYPSO_PROC CalypsoStartTransactionEx(P_CALYPSO_CTX ctx, BOOL *ratified, BYTE key_no, BYTE kif, BYTE sfi, BYTE rec_no, BYTE data[], SIZE_T *datasize);
...
CALYPSO_PROC CalypsoCardStoredValueGetForDebit(P_CALYPSO_CTX ctx, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardStoredValueGetForReload(P_CALYPSO_CTX ctx, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardStoredValueGetDecode(P_CALYPSO_CTX ctx, const BYTE get_sv_resp[], SIZE_T get_sv_respsize, signed long *balance, CALYPSO_STOREDVALUE_ST *target);
CALYPSO_PROC CalypsoCardStoredValueDebit(P_CALYPSO_CTX ctx, const BYTE get_sv_resp[], SIZE_T get_sv_respsize, signed long amount, WORD pdate, WORD ptime, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardStoredValueUnDebit(P_CALYPSO_CTX ctx, const BYTE get_sv_resp[], SIZE_T get_sv_respsize, signed long amount, WORD pdate, WORD ptime, BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardStoredValueReload(P_CALYPSO_CTX ctx, const BYTE get_sv_resp[], SIZE_T get_sv_respsize, signed long amount, WORD pdate, WORD ptime, BYTE pfree[2], BYTE resp[], SIZE_T *respsize);
CALYPSO_PROC CalypsoCardStoredValueCheck(P_CALYPSO_CTX ctx, const BYTE op_sv_resp[], SIZE_T op_sv_respsize);

/* Calypso parser */
/* -------------- */

CALYPSO_PROC CalypsoParseCardAtr(P_CALYPSO_CTX ctx, const BYTE atr[], SIZE_T atrsize);
CALYPSO_PROC CalypsoParseSamAtr(P_CALYPSO_CTX ctx, const BYTE atr[], SIZE_T atrsize);
CALYPSO_PROC CalypsoParseFci(P_CALYPSO_CTX ctx, const BYTE fci[], SIZE_T fcisize);
CALYPSO_PROC CalypsoParseIcc(P_CALYPSO_CTX ctx, const BYTE icc[], SIZE_T iccsize);
CALYPSO_PROC CalypsoParseSelectResp(P_CALYPSO_CTX ctx, const BYTE resp[], SIZE_T respsize, FILE_INFO_ST *file_info);
...
CALYPSO_PROC CalypsoSetXmlOutputStr(P_CALYPSO_CTX ctx, char *target, SIZE_T length);
CALYPSO_PROC CalypsoSetIniOutputStr(P_CALYPSO_CTX ctx, char *target, SIZE_T length);
CALYPSO_PROC CalypsoClearOutput(P_CALYPSO_CTX ctx);

CALYPSO_PROC CalypsoOutputCardAtr(P_CALYPSO_CTX ctx, const BYTE atr[], SIZE_T atrsize);
...
CALYPSO_PROC CalypsoOutputEnvironmentRecordEx(P_CALYPSO_CTX ctx, const BYTE data[], SIZE_T datasize);
CALYPSO_PROC CalypsoOutputHolderRecordEx(P_CALYPSO_CTX ctx, const BYTE data[], SIZE_T datasize);
CALYPSO_PROC CalypsoOutputEnvAndHolderRecordEx(P_CALYPSO_CTX ctx, const BYTE data[], SIZE_T datasize, BOOL flat);
CALYPSO_PROC CalypsoOutputContractRecordEx(P_CALYPSO_CTX ctx, const BYTE data[], SIZE_T datasize);
CALYPSO_PROC CalypsoOutputEventRecordEx(P_CALYPSO_CTX ctx, const BYTE data[], SIZE_T datasize);
