...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_WritePerso(SCARDHANDLE hCard,
                                                                 WORD address,
                                                                 const BYTE value[16]);
...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_Read(SCARDHANDLE hCard,
                                                           WORD address,
																													 BYTE data[16]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_ReadM(SCARDHANDLE hCard,
                                                            WORD address,
																														BYTE count,
																													  BYTE data[]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_ReadEx(SCARDHANDLE hCard,
                                                             BYTE cmd_code,
                                                             WORD address,
																														 BYTE count,
																													   BYTE data[]);

SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_Write(SCARDHANDLE hCard,
                                                            WORD address,
																														const BYTE data[16]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_WriteM(SCARDHANDLE hCard,
                                                             WORD address,
																														BYTE count,
																														const BYTE data[]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_WriteEx(SCARDHANDLE hCard,
                                                              BYTE cmd_code,
                                                              WORD address,
																															BYTE count,
																														  const BYTE data[]);
																																				
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_FirstAuthenticate(SCARDHANDLE hCard,
                                                                        WORD key_address,
...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_FollowingAuthenticate(SCARDHANDLE hCard,
                                                                            WORD key_address,
                                                                            const BYTE key_value[16]);

SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_VirtualCardSupport(SCARDHANDLE hCard,
                                                                         const BYTE install_id[16]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_VirtualCardSupportLast(SCARDHANDLE hCard,
                                                                             const BYTE install_id[16],
																																				     ...
																																				     BYTE picc_data[16],
																																						 BYTE picc_mac[8]);
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_VirtualCardSupportCheck(SCARDHANDLE hCard,
																																							const BYTE pcd_rnd[12],
																																				      const BYTE pcd_cap[],
																																				      BYTE pcd_cap_len,
...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_SelectVirtualCard(SCARDHANDLE hCard,
...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_VirtualCard(SCARDHANDLE hCard,
                                                                  const BYTE install_id[16],
...
SPROX_MIFPLUS_LIB LONG SPROX_MIFPLUS_API SCardMifPlus_VirtualCardEx(SCARDHANDLE hCard,
