/**h* SpringCard/PCSC_Calypso
 *
 * NAME
 *   PCSC_Calypso
 * 
 * DESCRIPTION
 *   SpringCard's wrapper for pcsc_calypso.dll, the library to work
 *   with Calypso cards within PC/SC
 *
 * COPYRIGHT
 ...
 *
 * HISTORY
 *   JDA 26/01/2011 : first official release
 *
 * PORTABILITY
...
namespace SpringCard.PCSC.Calypso
{
