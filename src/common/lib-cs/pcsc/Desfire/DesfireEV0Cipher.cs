...
namespace SpringCard.PCSC
{
...
#if _DEBUG_CIPHER
      Trace.WriteLine("CipherRecv(" + (new CardBuffer(data)).AsString() + ")");
      Trace.WriteLine("Blocks : " + block_count);
#endif
...
#if _DEBUG_CIPHER
        Trace.WriteLine("Block " + block + "/" + block_count + ", IV=" + (new CardBuffer(IV)).AsString() + ", C=" + (new CardBuffer(t)).AsString());
#endif

        core.Encrypt(ref t);
				  
#if _DEBUG_CIPHER
        Trace.WriteLine("\t   " + (new CardBuffer(t)).AsString());
#endif
...
#if _DEBUG_CIPHER
        Trace.WriteLine("\t--> " + (new CardBuffer(data, 8 * block, 8)).AsString());
#endif
			}
...
#if _DEBUG_CIPHER
      Trace.WriteLine("CipherSend(" + (new CardBuffer(data)).AsString() + ")");
#endif
...
#if _DEBUG_CIPHER
      Trace.WriteLine("           " + (new CardBuffer(data)).AsString());
      Trace.WriteLine("Blocks : " + block_count);
#endif
...
#if _DEBUG_CIPHER
        Trace.WriteLine(", C=" + (new CardBuffer(data, 8 * block, 8)).AsString());
#endif
			}
    ...
    static bool do_des_test(string key, string plain, string cipher)
    {
      ...
      Trace.WriteLine(key + "," + plain + "," + cipher);
      ...
      Trace.WriteLine((new CardBuffer(b)).AsString());
      Trace.WriteLine((new CardBuffer(c)).AsString());
      ...
      Trace.WriteLine((new CardBuffer(b)).AsString());
      Trace.WriteLine((new CardBuffer(p)).AsString());
...
#if _DEBUG_MAC
      Trace.WriteLine("MAC(" + (new CardBuffer(data)).AsString() + ")");
#endif
...
#if _DEBUG_MAC
      Trace.WriteLine("    " + (new CardBuffer(buffer)).AsString());
#endif
