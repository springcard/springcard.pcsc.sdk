...
namespace SpringCard.NFC
{
	...
	public class RtdVCard : RtdMedia
	{
		...
		/**v* SpringCard.NFC/RtdVCard.Nickname
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Email_alternative
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pager
		 *
		 * SYNOPSIS
		 *   public string Pager
		 * 
		...
		/**v* SpringCard.NFC/RtdVCard.Home_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Cell_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.First_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Family_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Business_phone
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Email
		 *
		 * SYNOPSIS
		 *   public string Email
		 * 
		...
		/**v* SpringCard.NFC/RtdVCard.Birthday
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Country
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Town
		 *
		 * SYNOPSIS
		 *   public string Town
		 * 
		...
		/**v* SpringCard.NFC/RtdVCard.Address2
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Address1
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Post_Code
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Region_State
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Role
		 *
		 * SYNOPSIS
		 *   public string Role
		 * 
		...
		/**v* SpringCard.NFC/RtdVCard.Title
		 *
		 * SYNOPSIS
		 *   public string Title
		 * 
		...
		/**v* SpringCard.NFC/RtdVCard.Company
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Address1
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Address2
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Post_Code
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Region_State
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Town
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Pro_Country
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Middle_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Prefix_name
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdVCard.Suffix_name
		 *
		 * SYNOPSIS
		 *   public string Prefix_name
		 * 
		...
		/**m* SpringCard.NFC/RtdVCard.set_photo
		 *
		 * SYNOPSIS
		...
		/**m* SpringCard.NFC/RtdVCard.get_photo
		 *
		 * SYNOPSIS
		...
		/**m* SpringCard.NFC/RtdVCard.set_input_texts
		 *
		 * SYNOPSIS
