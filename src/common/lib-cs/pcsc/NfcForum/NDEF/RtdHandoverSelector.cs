/**h* SpringCard.NFC/RtdHandoverSelector
 *
 * NAME
...
namespace SpringCard.NFC
{
	...
	/**c* SpringCard.NFC/RtdHandoverSelector
	 *
	 * NAME
	 *   RtdHandoverSelector
	 * 
	...
	public class RtdHandoverSelector : Rtd
	{
		...
		/**v* SpringCard.NFC/RtdHandoverSelector.AlternativeCarriers
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdHandoverSelector.RelatedAbsoluteUris
		 *
		 * SYNOPSIS
		...
		/**m* SpringCard.NFC/RtdHandoverSelector.Encode
		 *
		 * SYNOPSIS
