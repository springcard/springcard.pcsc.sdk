/**h* SpringCard.NFC/RtdAlternativeCarrier
 *
 * NAME
...
namespace SpringCard.NFC
{
	...
	/**c* SpringCard.NFC/RtdAlternativeCarrier
	 *
	 * NAME
	...
	public class RtdAlternativeCarrier : Rtd
	{
		...
		/**v* SpringCard.NFC/RtdAlternativeCarrier.CarrierPowerState
		 *
		 * SYNOPSIS
		...
		/**v* SpringCard.NFC/RtdAlternativeCarrier.CarrierDataReference
		 *
		 * SYNOPSIS
		 *   public byte CarrierPowerState
		 * 
		...
		/**m* SpringCard.NFC/RtdAlternativeCarrier.Encode
		 *
		 * SYNOPSIS
